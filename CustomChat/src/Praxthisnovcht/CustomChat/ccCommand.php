...
class ccCommand {
    ...
    public function onCommand(CommandSender $sender, Command $command, $label, array $args) {
		...
		if ((strtolower ( $command->getName () ) == "customchat")) {
			...
			$sender->sendMessage (TextFormat::RED . "Usage: /defprefix <Player> <Prefix>");
			$sender->sendMessage (TextFormat::RED . "Usage: /setprefix <Player> <Prefix>");
			$sender->sendMessage (TextFormat::RED . "Usage: /deftags <tags>");
			$sender->sendMessage (TextFormat::RED . "Usage: /tags <tags> <player>");
			$sender->sendMessage (TextFormat::RED . "Usage: /setnick <Nick> <player>");
			$sender->sendMessage (TextFormat::RED . "Usage: /delnick <player>");
			return;
		}

/**		if ((strtolower ( $command->getName () ) == "customchat options")) {
